...
def download_tlc_files(
    ...
    for month in months:
        ...
        _download_to_adls(source_url, destination_path, file_name, dbutils, staging_dir)


def download_zone_lookup(landing_base_path: str, dbutils: Any, staging_dir: str) -> None:
    ...
    _download_to_adls(ZONE_LOOKUP_URL, destination_path, file_name, dbutils, staging_dir)
